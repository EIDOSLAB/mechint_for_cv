...
class HookedVisionTransformer():
  ...
  def get_ViT(self, model_name):
    ...
    # Qui devo fare in modo di caricare uno dei modelli prunati.

    model = CLIPModel.from_pretrained(model_name)
    processor = CLIPProcessor.from_pretrained(model_name) # Dove viene usato? Come recupero quello dei modelli prunati? Mi serve?
